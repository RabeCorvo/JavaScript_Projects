...
//This function is for placing an x or o in a squre.
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        //Active player may only be 'X' or 'O' so, if not 'X' it must be 'O'
            ...
            //If active Player is equa; to 'O', the o.png is placed in HTML.
    ...
    //This function results in a random spuare being selected.
    function computersTurn() {
        ...
        while(!success) {
            ...
            //If the random number evalutes returns true, the square hasn't been selected yet.
...
function checkWinConditions() {
    ...
    //It is used to check for each win condtion.
...
//This function utilitzes html canvas to draw wind lines.
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    function animateLineDrawing() {
        //This variable create the loop for when the game ends it restarts.
    ...
    //Then clears canvas, resets game, and allows clikcing again.
